...
function DashboardPage() {
  // to get the current logged in user from localStorage
...
<div className="mb-10">
  ...
  <div className="flex space-x-6">
    <div 
      className="w-1/3 border border-gray-300 rounded-3xl p-6 flex items-center justify-center cursor-pointer hover:bg-gray-50"
      onClick={() => handleNavigation('web-development')}
    >
      <p className="text-center">Web Development</p>
    </div>
    <div 
      className="w-1/3 border border-gray-300 rounded-3xl p-6 cursor-pointer hover:bg-gray-50"
      onClick={() => handleNavigation('performance-innovation')}
    >
      <p className="text-center">Performance Innovation Task in Life and Works of Rizal</p>
    </div>
    <div 
      className="w-1/3 border border-gray-300 rounded-3xl p-6 cursor-pointer hover:bg-gray-50"
      onClick={() => handleNavigation('packet-tracer')}
    >
...
<div className="mb-10">
  ...
  <div className="flex space-x-6">
    ...
    <div 
      className="w-1/3 border border-gray-300 rounded-3xl p-6 cursor-pointer hover:bg-gray-50"
      onClick={() => handleNavigation('packet-tracer-project')}
    >
      <p className="text-center">Packet Tracer Installation and Configuration</p>
    </div>
    <div 
      className="w-1/3 border border-gray-300 rounded-3xl p-6 cursor-pointer hover:bg-gray-50"
      onClick={() => handleNavigation('web-development-project')}
    >
      <p className="text-center">Web Development</p>
    </div>
  </div>
